...
def generate_ai_analysis(summary, assets, news_list):
    ...
    {{
        "market_analysis": "บทวิเคราะห์ตลาด (HTML format) โดยให้สรุปแยกเป็น 2 หมวดหมู่ชัดเจน: <h4>📈 ปัจจัยที่มีผลต่อตลาดหุ้น</h4><ul>...</ul> <h4>🪙 ปัจจัยที่มีผลต่อทองคำ</h4><ul>...</ul> (วิเคราะห์ปัจจัยบวก/ลบจากข่าว)",
        "recommendations": {{
